/*** Created by nedved on 10/01/17, 1.0.5.
 *
...
module.exports = function(params) {
    ...
    if(params.log_provider){
        if(params.log_provider === 'logzio'){
            var transporterName  =  'LogzioLogger';
            var logzioWinstonTransport = require('winston-logzio')({name:transporterName});
            var loggerOptions = {
                token: params.apiKey
            };
            that.remove(transporterName);
